        ...
        <div class="container">
            <div class="column"><br><br>
				...
				<?php
					...
					echo $row[0];
					echo("</td></tr><tr><td>First Name:&nbsp;</td><td>");
					echo $row[1];	
					...
					echo $row[4];
					echo("</td></tr><tr><td>Street address:&nbsp;</td><td>");
					echo $row[5];
					echo("</td></tr><tr><td>Apt / Unit:&nbsp;</td><td>");
					echo $row[6];
