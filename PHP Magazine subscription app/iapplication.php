	...
	<section id="stype">
        ...
        <div class="container">
            <div class="column"><br><br>
					...
					$qry="insert into individual(ApplicationNo,fname,lname,email,phone,street,Hno,city,state,zip,cardtype,cardnumber,nameoncard,expirydate,type) values('$appno','$fname','$lname','$email','$phone','$street','$hno','$city','$state','$zipc','$cardtype','$cardnumber','$nameoncard','$expirydate','individual')";
