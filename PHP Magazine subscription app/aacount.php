...
$qry1="insert into smsaccount(ApplicationNo,userid,password,type,startdate,enddate,email,phone) values('$row[0]','$uid','$password','individual','$date','$nextdate','$row[3]','$row[4]')";
$qry2="insert into smsaddress(ApplicationNo,street,hno,city,state,zip,noofcopies) values('$row[0]','$row[5]','$row[6]','$row[7]','$row[8]','$row[9]',1";
...
echo "<br><br>Next renewal date for the customer is $nextdate ";
echo "<br><br><br><br><br><br><br><br><br><br><br><br><br>";
$qry3="DELETE FROM individual WHERE ApplicationNo=$row[0]";
